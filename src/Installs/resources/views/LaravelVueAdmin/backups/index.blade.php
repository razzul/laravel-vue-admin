...
@section("headerElems")
@lv_access("Backups", "create")
	<button class="btn btn-success btn-sm" id="CreateBackup">Create Backup</button>
@endlv_access
@endsection
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('LaravelVueAdmin.adminRoute') . '/backup_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
			...
			success: function( data ) {
				if(data.status == "success") {
					...
					$('body').pgNotification({
						...
						timeout: 0,
						type: "success",
						thumbnail: '<img width="40" height="40" style="display: inline-block;" src="{{ asset('LaravelVueAdmin/assets/img/laraadmin_logo_white.png') }}" data-src="assets/img/profiles/avatar.jpg" data-src-retina="assets/img/profiles/avatar2x.jpg" alt="">'
					}).show();
					setTimeout(function() {
